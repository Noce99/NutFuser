...
export WORK_DIR=/home/enrico/Projects/Carla/carla_garage
...
# export TEAM_CONFIG=${WORK_DIR}/pretrained_models/longest6/tfpp_all_0 # THEIR MODEL
export TEAM_CONFIG=${WORK_DIR}/my_models/epoch_17_second_training # MY MODEL
