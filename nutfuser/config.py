...
# TAKE DATA
MAX_NUM_OF_ATTEMPTS = 10 # maximum number of attempts to sturt up all the carla's chain!
CARLA_FPS = 20
IMAGE_W = 1024
IMAGE_H = 256
BEV_IMAGE_W = 256
...
FRAME_TO_KEEP_GOING_AFTER_THE_END = AMOUNT_OF_CARLA_FRAME_AFTER_WE_SAVE*200 # we want to be sure to explore enaught space fro the last waypoint ground truth
